...
<template>
    <div class="w-full min-h-[88vh] flex justify-center items-center scroll-mt-[90px]" id="contact">
        <div ref="contactBox"
            ...
            <p class="max-w-[460px] h-auto text-3xl text-center font-semibold text-white-primary">
            ...
            <div
                class="w-auto h-[260px] border-2 border-orange-border flex flex-col justify-center items-center gap-5 py-3 px-4 rounded-[4px] max-md:w-full max-md:justify-around">
                <h1 class="font-semibold text-white-letters text-5xl max-md:text-4xl">Contact</h1>
                <div class="flex flex-col gap-[15px]">
                    <p class="text-2xl font-semibold text-white-letters">
